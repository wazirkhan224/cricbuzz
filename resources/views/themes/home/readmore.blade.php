                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="card wow animated fadeInUp">
                                        <a href="#" style="text-decoration: none;">    
                                            <img src="{{asset('images/'.$slug->file)}}" alt="card-1" class="card-img-top">
                                        </div>
                                            <div class="card-body">
                                          </a>

                                          <div class="">
                                                <header> <h3 class="text-success text-center">
                                                 {{$slug->title}}</h3> </header>
                                                  <article>
                                                    <p class="font">
                                                      {{str_limit($slug->description,200)}}      
                                                    </p>
                                                  </article>
                                              </div>                                        
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card wow animated fadeInLeft mt-5">
                                        ...
                                        <img src="{{asset('images/'.$latestp->file)}}" alt="card-1" class="card-img-top">
                                        <div class="card-body">
                                            <h5 class="text-center text-success" >
                                            {{$latestp->title}} 
                                            </h5>
                                            <p class="wow animated fadeInLeft ">
                                                {{str_limit($latestp->description,200)}}
                                              </p>
                                                }
                                            
                                        </div>
                                      <a href="{{route('admin_post-showw',['id'=>$latestp->id,'slug'=>$latestp->slug])}}"> 
