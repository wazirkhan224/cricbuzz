                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div class="card wow animated fadeInUp">
                                        <a href="#" style="text-decoration: none;">    <img src="images/blog new.png" alt="card-1" class="card-img-top">
                                        </div>
                                            <div class="card-body">
                                          ...
                                          <div class="">
                                                <header> <h3 class="text-success text-center">ICC World Cup 2019</h3> </header>
                                                <h5>Biggest event of Cricket</h5>
                                                  <article><p class="font">Started on October 07, 2004, Mustakbil.com is Pakistan's leading jobs site. It helps jobseekers in finding the jobs of their choice, while providing a unique platform for employers to advertise career opportunities and find valuable human resources for their organization.
          
                                                    Mustakbil.com is known to be a reliable place to apply online for jobs, easy to use interface, fastest browsing experience and rich features set. That's the reason we are able to gain and maintain the trust of the users of our website.
                                                    
                                                    The contrubutions by Mustakbil.com and its brand value was acknowledged in a graceful ceremony held at Governor House, Karachi on May 7th, 2010 where Prime Minister Islamic Republic of Pakistan Syed Yousuf Raza Gilani conferred Emerging Brand of the Year Award to Mr. Naveed Ahmed, Founder & CEO Mustakbil.com.
                                                    
                                                    Mustakbil.com is a leading jobs site of Pakistan with over 65,000 employers and millions of active and engaged web users. High standards and special concerns about consumer's privacy entitled Mustakbil.com for the seal of certification by TRUSTe - world leader in consumer privacy protection.
                                                    
                                                    Due to its remarkable contribution towards the society, Foundation for Youth And Social Entrepreneurship (FYSE) selected Mustakbil.com under top 100 entrepreneurial projects in Asia.
                                                    
                                                    Mustakbil.com's development team is working for the continuous improvement of the website and new features are introduced periodically to give users a more enjoyable experience.
                                                       </p></article> 
                                                       <h5 class="txtColor"> Who is going to win</h5>
                                                       <article><p class="font"> Mustakbil.com is an online venture of TechnoBird - a Pakistan based IT services firm. Founded in 2002, TechnoBird a complete web solutions provider with its operations based in Pakistan comes to you with the message – put your business and services on the fast track of growth with the next generation tools of information technology.
                                                           </p></article> 
                                                           <h5 class="txtColor"> Teams</h5>
                                                       <article><p class="font">Our Strength is derived from the motivation - of delivering service of a high order. And working towards it, is our team - dedicated, innovative and with a keen sense of competition. The team at TechnoBird is a result of the coming together of qualified professionals capable of providing the best of creative intellectual innovative and cost effective packages for varied requirements.
                                                           </p></article> 
                                              </div>                                        
                                    </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card wow animated fadeInLeft mt-5">
